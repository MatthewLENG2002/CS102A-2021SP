...
/*       int status, 1 represents uncovered, 0 represents covered, -1 represents flagged
 ...
 */
    ...
    public boolean uncover(int x, int y,int[][] map) {
        if (map[x-1][y-1] >=0){
            statusmap[x-1][y-1] = 1;
            return true;
        }
    ...
    public boolean flag(int x, int y, int[][] map) {
        if (map[x-1][y-1] < 0){
            statusmap[x-1][y-1] = -1;
            return true;
        }
